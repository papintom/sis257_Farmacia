...
export class CreateUsuarioDto {
  ...
  @MaxLength(50, {
    message: 'El campo "nombre" no puede exceder los 50 caracteres.',
  })
  ...
  @MaxLength(50, {
    message: 'El campo "apellido" no puede exceder los 50 caracteres.',
  })
  ...
  @MaxLength(50, {
    message: 'El campo "rol" no puede exceder los 50 caracteres.',
  })
  readonly rol: string;
}
